...
public class File2EsExecutorTest extends AbstractTest {
    ...
    @Test
    void test() {
        File2EsExecutor.builder().build().execute(File2EsTask.of(), new File("/Users/xuyao/Downloads/INT_PAB_CC_TEST-NAME-LIST_20201010_T_00.txt"), StandardCharsets.UTF_8);
    }
}
